...
export const Tasks = () => {
    ...
    const params = {};
    const tasksQuery = useFetchQuery('admin.tasks.index_content', params, 'tasks');
        ...
        try {
            ...
            SwalReact.fire({
                ...
                if (result.isConfirmed) {
                    axios.post(route("admin.tasks.status",{id: tasksId}))
                        .then(response => {
                ...
                <Col>
                    {filteredTasks && filteredTasks.length > 0 ? (
                        ...
                        >
                            ...
                            <Column
                                header="Asignado a"
                                body={(rowData) => `${rowData.user_to.name} ${rowData.user_to.last_name}`}
                                bodyStyle={{ whiteSpace: 'nowrap', textAlign: 'start' }}
                            />
